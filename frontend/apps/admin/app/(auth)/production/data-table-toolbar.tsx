...
import { handleUpload } from '@admin/(auth)/production/csv-upload/csv-upload-uitls';

interface DataTableToolbarProps {
	store: QueryInfiniteStoreType<ProductionTableType[], { content: string; limit: number }>;
}

export const DataTableToolbar: React.FC<DataTableToolbarProps> = ({ store }) => {
