...
import { handleUpload } from '@admin/(auth)/vod/csv-upload/csv-upload-utils';
import { TableName } from '@atsumedia/data';
import { userPoolClient } from '@atsumedia/amplify-client';

interface DataTableToolbarProps {
	onOpen: () => Promise<boolean>;
	store: QueryInfiniteStoreType<VodType[], { content: string; limit: number }>;
}
